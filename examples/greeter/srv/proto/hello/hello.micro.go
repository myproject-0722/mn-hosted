...
type SayService interface {
	...
	Doing(ctx context.Context, in *Request, opts ...client.CallOption) (*Response, error)
}
...
func (c *sayService) Doing(ctx context.Context, in *Request, opts ...client.CallOption) (*Response, error) {
	req := c.c.NewRequest(c.name, "Say.Doing", in)
	out := new(Response)
	err := c.c.Call(ctx, req, out, opts...)
	if err != nil {
		return nil, err
...
type SayHandler interface {
	...
	Doing(context.Context, *Request, *Response) error
}

func RegisterSayHandler(s server.Server, hdlr SayHandler, opts ...server.HandlerOption) error {
	type say interface {
		Hello(ctx context.Context, in *Request, out *Response) error
		Doing(ctx context.Context, in *Request, out *Response) error
	}
	type Say struct {
		say
	}
...
func (h *sayHandler) Doing(ctx context.Context, in *Request, out *Response) error {
	return h.SayHandler.Doing(ctx, in, out)
}
